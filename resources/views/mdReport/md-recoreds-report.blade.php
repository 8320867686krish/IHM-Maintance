...
<div class="section-1-1">
    ...
    @foreach($mdnoresults as $index=>$record)
    @if($index !== 0)
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                      ...
                      <tr>
                        <td colspan="4" style="text-align: center;padding-top:10px;padding-bottom:10px;"><b>MD Information</b></td>
                    </tr>
                      <tr>
                        <td><strong>MD No</strong></td>
                         <td>{{ $record->makeModel->md_no ?? '' }}</td>

                        <td><strong>MD Date of Declaration</strong></td>
                         <td>{{ $record->makeModel->md_date ?? '' }}</td>
                    </tr>
                      <tr>
