<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    ...
    <div class="accrodion-regular">
        <div id="accordion">
            <div class="card">
                <div class="card-header" id="headingma21">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed d-flex justify-content-between w-100" data-toggle="collapse" data-target="#collapsema1w" aria-expanded="false" aria-controls="collapsema1w">
                            PO Records
                ...
                <div id="collapsema1w" class="collapse show" aria-labelledby="headingma21" data-parent="#accordion" style="">
                    <div class="card-body">
            ...
            <div class="card">
                <div class="card-header" id="headingma62">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed d-flex justify-content-between w-100" data-toggle="collapse" data-target="#collapsema2d" aria-expanded="false" aria-controls="collapsema2d">
                ...
                <div id="collapsema2d" class="collapse" aria-labelledby="headingma62" data-parent="#accordion">
                    <div class="card-body">
                        <table class="table table-striped table-bordered first">
                            <thead>
                                <tr>
