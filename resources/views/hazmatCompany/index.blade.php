...
@endsection
@section('shiptitle','Hazmat Company')
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Hazmat Company</h2>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
                                            ...
                                            <tr class="hazmatCompanyRowTr">
                                                ...
                                                <td>
                                                    ...
                                                    @can('hazmatCompany.remove')
                                                        <a href="{{ route('hazmatCompany.delete', ['id' => $hazmatCompanyValue->id]) }}" class="ml-2 delete-btn">
