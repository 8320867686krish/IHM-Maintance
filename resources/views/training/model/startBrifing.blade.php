                    ...
                    <input type="hidden" id="id" name="id">
                        ...
                        <div class="col-12 col-md-12 col-lg-12 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="number_of_attendance" name="number_of_attendance" class="form-control @error('number_of_attendance') is-invalid @enderror" onchange="removeInvalidClass(this)">
