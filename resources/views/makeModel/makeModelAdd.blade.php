                        ...
                        <form method="post" action="{{ route('documentdeclaration.store') }}" class="needs-validation" novalidate id="makeModelForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6 mt-3">
                                    <div class="form-group">
                                        <label for="part">Ref No <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="ref_no" name="ref_no" value="{{ old('ref_no', $model->ref_no ?? '') }}" autocomplete="off" onchange="removeInvalidClass(this)">
                                        <div class="invalid-feedback error" id="partError"></div>
                                    </div>
                                </div>
                            </div>
