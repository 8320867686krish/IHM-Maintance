...
<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
    <div class="card" style="background-color: #ebeef2;">
        ...
        <a href="{{ route('credential.remove', ['id' => $value->id]) }}" class="float-right text-right mt-1 mr-1 delete-credential" data-id="{{$value['id']}}">
        ...
        <div class="card-body">
            ...
            <a href='{{asset("uploads/credentials/")."/".$value->document}}' download="{{$value->document}}" class="float-right">
