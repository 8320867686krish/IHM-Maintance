...
class dashobardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard', compact('ships', 'shipsPo', 'relevantCounts', 'nonRelevantCounts', 'currentUserRoleLevel', 'designatePerson', 'currentUserRoleName','hazmatCompany','path','imagekey','title','routename'));
    }
